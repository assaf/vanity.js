...
describe "activity", ->
  ...
  describe "actor", ->
    ...
    describe "name only", ->
      ...
      it "should include actor name in title", ->
        assert browser.document.title.endsWith(" Assaf posted")
  ...
  describe "object", ->
    ...
    describe "name only", ->
      ...
      it "should include object name in title", ->
        assert browser.document.title.endsWith(" Assaf tested this view")
    ...
    describe "URL only", ->
      ...
      it "should include object URL in title", ->
        assert browser.document.title.endsWith(" Assaf tested http://awe.sm/5hWp5")
    ...
    describe "name and URL", ->
      ...
      it "should include object name in title", ->
        assert browser.document.title.endsWith(" Assaf tested this link")
